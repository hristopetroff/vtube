...
$related_videos    = $db->rawQuery("SELECT * FROM " . T_VIDEOS . " WHERE MATCH (title) AGAINST ('$query_video_title') AND id <> '{$get_video->id}' $not_in_query AND privacy = 0 ORDER BY `id` DESC LIMIT 20");
