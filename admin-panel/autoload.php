        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li <?php echo ($page == 'manage-games' || $page == 'create-game' || $page == 'edit-game') ? 'class="active"' : ''; ?>>
                        <a href="javascript:void(0);" class="menu-toggle">
                            <i class="material-icons">games</i>
                            <span>Games</span>
                        </a>
                        <ul class="ml-menu">
                            <li <?php echo ($page == 'create-game') ? 'class="active"' : ''; ?>>
                                <a href="<?php echo PT_LoadAdminLinkSettings('create-game'); ?>">Add New Game</a>
                            </li>
